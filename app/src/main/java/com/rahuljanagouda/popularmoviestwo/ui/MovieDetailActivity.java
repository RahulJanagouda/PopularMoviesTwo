...
public class MovieDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null || !savedInstanceState.containsKey(MovieDetailFragment.MOVIE_RESULT_KEY)) {
            Bundle arguments = new Bundle();
            arguments.putParcelable(MovieDetailFragment.MOVIE_RESULT_KEY,
                    getIntent().getParcelableExtra(MovieDetailFragment.MOVIE_RESULT_KEY));
...
//            movieResult = savedInstanceState.getParcelable(MovieDetailFragment.MOVIE_RESULT_KEY);
...
//            Bundle arguments = new Bundle();
//            arguments.putString(MovieDetailFragment.MOVIE_RESULT_KEY,
